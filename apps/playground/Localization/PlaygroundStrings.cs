...
public static class PlaygroundStrings {
    ...
    private static readonly Dictionary<string, string> En = new() {
        ...
        ["playground.lede"] =
            "Build an expression by choosing a method at each step — the whole public surface the " +
            "library exposes is here, not a curated subset. Arguments are typed directly into the " +
            "call; once at least one step is chosen, <code>Generate</code> below draws a value.",
        ...
        ["argument.expectsDateTime"]                  = "a date and time, e.g. 2026-08-15T14:30:00",
    ...
    private static readonly Dictionary<string, Translation> Fr = new() {
        ...
        ["playground.lede"] = new(
            "Construisez une expression en choisissant une méthode à chaque étape — toute la surface " +
            "publique de la librairie est proposée ici, pas un sous-ensemble choisi. Les arguments se " +
            "saisissent directement dans l'appel ; une fois au moins une étape choisie, " +
        ...
        ["argument.expectsDateTime"]                = new("une date et une heure, ex. 2026-08-15T14:30:00", "a date and time, e.g. 2026-08-15T14:30:00"),
