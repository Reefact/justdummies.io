...
| [ADR-0006](0006-the-first-act-follows-one-factory-en.md) | The first act follows one factory, not the library's surface | Proposed |
| [ADR-0007](0007-the-third-act-answers-before-it-fails-en.md) | The third act answers before it shows a failure | Proposed |
