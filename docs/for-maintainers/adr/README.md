...
| [ADR-0021](0021-a-release-tag-is-verified-against-the-pr-that-named-it-en.md) | A release tag is verified against the PR that named it, not its own creation clock | Proposed |
