# ADR-0010 | Le site exécute un script Worker, et seulement pour la mesure

🌍 🇫🇷 Français (ce fichier) · 🇬🇧 [English](0010-the-site-runs-one-worker-script-for-measurement-en.md)
